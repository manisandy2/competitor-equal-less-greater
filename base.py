...
for r in range(4,len(data.keys())):
    print(data.keys()[r])
    data.loc[(data[data.keys()[3]] == data[data.keys()[r]]),data.keys()[r] + " equal"] = data[data.keys()[3]] - data[data.keys()[r]]

    data.loc[(data[data.keys()[3]] > data[data.keys()[r]]),data.keys()[r] + " greater"] = data[data.keys()[3]] - data[data.keys()[r]]

    data.loc[(data[data.keys()[3]] < data[data.keys()[r]]),data.keys()[r] + " lesser"] = data[data.keys()[r]] - data[data.keys()[3]]
